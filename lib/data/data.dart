...
final List<User> onlineUsers = [
  ...
  User(
    ...
    name: 'Godwin Dorglo',
    imageUrl:
        'https://www.fofoofotech.com/wp-content/uploads/2020/03/IMG-20200304-WA0010-e1587001028277.jpg',
  ),
  User(
    handle: 'caro1z',
    name: 'Carolyn Duncan',
...
final List<Post> posts = [
  Post(
      user: currentUser,
      caption: 'Check out these cool puppies',
      timeAgo: '2',
      comments: '10',
  ...
  Post(
    ...
    comments: '8',
    imageUrl:
        'https://images.unsplash.com/photo-1580674285054-bed31e145f59?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80',
    likes: 683,
  ),
  Post(
    user: onlineUsers[1],
  ...
  Post(
    ...
    timeAgo: '6',
    imageUrl:
        'https://images.unsplash.com/photo-1493135637657-c2411b3497ad?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=751&q=80',
    likes: 482,
  ),
  Post(
    user: onlineUsers[4],
